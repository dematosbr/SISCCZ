...
try {
	$pesquisa_sql = $db_con->prepare('SELECT * FROM tbl_tecnologia_da_informacao_sistemas_acesso WHERE tbl_tecnologia_da_informacao_sistemas_acesso_usuario=:usuario ');
	$pesquisa_sql->bindParam(':usuario', mb_strtoupper(retirarAcentos($_POST['usuario'])));   		
